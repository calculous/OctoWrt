...
- Proceed with step 2
  ...
  ```
  cd /tmp
  wget https://github.com/calculous/OctoWrt/raw/main/scripts/1_format_extroot.sh
  ...
  ```
  cd /tmp
  wget https://github.com/calculous/OctoWrt/raw/main/scripts/2_octoprint_install.sh
